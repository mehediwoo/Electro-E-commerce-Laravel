...
<div class="row-fluid sortable">
    <div class="box span12">
        ...
        <div class="box-content">
            <form class="form-horizontal" action="{{url('/updateSizes/'.$editSize->id)}}" method="post">
                @csrf
                <fieldset>
                    <div class="control-group">
                        <label class="control-label" for="date01">Size</label>
                        <div class="controls">
                            <input type="text" class="input-xlarge" name="size" data-role="tagsinput" required value="{{ $editSize->size }}">
                        </div>
                        @error('size')
